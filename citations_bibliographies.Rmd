...
You can get Zotero from <https://www.zotero.org>. One reason I like Zotero 
...
For instance, in the example bibliography 
file `lab_05.bib`, the textbook, _Global Warming: Understanding the Forecast_
has the key `archer.forecast.2011`.[^3] 
...
Below, I have inserted the line
```
# References
```
